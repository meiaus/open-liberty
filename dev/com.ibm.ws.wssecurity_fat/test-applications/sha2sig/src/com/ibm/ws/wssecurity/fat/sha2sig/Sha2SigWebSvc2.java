...
@WebServiceProvider(targetNamespace="http://sha2sig.wssecfvt.test",
    portName="UrnSha2Sig2",
    serviceName="Sha2SigService2",
    wsdlLocation = "WEB-INF/Sha2SigAlg.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class Sha2SigWebSvc2 implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://sha2sig.wssecfvt.test/types\"><provider>This is WSSECFVT SHA256 Digest Web Service.</provider></soapenv:Body></soapenv:Envelope>");
