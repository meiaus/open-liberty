...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX25Service", portName="UrnX509Token25",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax25 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax25)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax25</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
