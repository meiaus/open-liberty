...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX27Service", portName="UrnX509Token27",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax27 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax27)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax27</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
