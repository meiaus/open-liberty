...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX22Service", portName="UrnX509Token22",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax22 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax22)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax22</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
