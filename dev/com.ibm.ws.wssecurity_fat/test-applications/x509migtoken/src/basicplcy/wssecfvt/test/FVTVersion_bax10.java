...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX10Service", portName="UrnX509Token10",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax10 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax10)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax10</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
