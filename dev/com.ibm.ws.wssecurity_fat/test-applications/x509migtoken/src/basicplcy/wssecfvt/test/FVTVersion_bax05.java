...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX05Service", portName="UrnX509Token05",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax05 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax05)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax05</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
