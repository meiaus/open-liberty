...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX26Service", portName="UrnX509Token26",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax26 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax26)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax26</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
