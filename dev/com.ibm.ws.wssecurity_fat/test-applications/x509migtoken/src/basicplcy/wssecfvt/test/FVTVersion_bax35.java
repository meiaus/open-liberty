...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX35Service", portName="UrnX509Token35",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax35 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax35)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax35</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
