...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX04Service", portName="UrnX509Token04",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax04 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax04)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax04</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
