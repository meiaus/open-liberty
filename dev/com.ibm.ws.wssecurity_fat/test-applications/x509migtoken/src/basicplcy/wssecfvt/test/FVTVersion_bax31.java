...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX31Service", portName="UrnX509Token31",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax31 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax31)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax31</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
