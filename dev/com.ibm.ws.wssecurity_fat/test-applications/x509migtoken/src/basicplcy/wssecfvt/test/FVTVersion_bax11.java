...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX11Service", portName="UrnX509Token11",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax11 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax11)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax11</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
