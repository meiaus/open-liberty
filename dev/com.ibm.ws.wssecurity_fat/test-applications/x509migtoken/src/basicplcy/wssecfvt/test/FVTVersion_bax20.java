...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX20Service", portName="UrnX509Token20",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax20 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax20)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax20</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
