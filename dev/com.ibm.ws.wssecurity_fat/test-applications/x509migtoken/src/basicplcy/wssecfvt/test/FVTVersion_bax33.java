...
@WebServiceProvider(targetNamespace="http://x509mig.libertyfat.test/contract",
                    serviceName="FatBAX33Service", portName="UrnX509Token33",
 ...
 * @author Todd Roling
 */
public class FVTVersion_bax33 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            System.out.println("Incoming Client Request as a SOAPMessage(mig bax33)");
            ...
            StringReader respMsg = new StringReader(
                               ...
                               "<SOAP-ENV:Body><provider><message>LIBERTYFAT X509 bax33</message></provider></SOAP-ENV:Body>" +
                               "</SOAP-ENV:Envelope>"  );
