 ...
 * generated in the test.wssecfvt.sha2sig.types package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: test.wssecfvt.sha2sig.types
     * 
     */
