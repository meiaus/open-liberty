        ...
        protected void doWorker(HttpServletRequest request,
                ...
                try {
                        ...
                        if (rawServiceName.equals("Sha2SigService1")) {
                                ...
                                Sha2SigService1 service = new Sha2SigService1(wsdlURL,
                                                serviceName);
                        ...
                        if (rawServiceName.equals("Sha2SigService2")) {
                                ...
                                Sha2SigService2 service = new Sha2SigService2(wsdlURL,
                                                serviceName);
                                dispSOAPMsg = service.createDispatch(servicePort,
                                                SOAPMessage.class, Mode.MESSAGE);
                        }
                        if (rawServiceName.equals("Sha2SigService3")) {
                            ...
                            Sha2SigService3 service = new Sha2SigService3(wsdlURL,
                                            serviceName);
                            dispSOAPMsg = service.createDispatch(servicePort,
                                            SOAPMessage.class, Mode.MESSAGE);
                        }
                        if (rawServiceName.equals("Sha2SigService4")) {
                            ...
                            Sha2SigService4 service = new Sha2SigService4(wsdlURL,
                                            serviceName);
                            dispSOAPMsg = service.createDispatch(servicePort,
                                            SOAPMessage.class, Mode.MESSAGE);
                        }
                        if (rawServiceName.equals("Sha2SigService5")) {
                            ...
                            Sha2SigService5 service = new Sha2SigService5(wsdlURL,
                                            serviceName);
                            dispSOAPMsg = service.createDispatch(servicePort,
                                            SOAPMessage.class, Mode.MESSAGE);
                        }
                        if (rawServiceName.equals("Sha2SigService6")) {
                            ...
                            Sha2SigService6 service = new Sha2SigService6(wsdlURL,
                                            serviceName);
                            dispSOAPMsg = service.createDispatch(servicePort,
                                            SOAPMessage.class, Mode.MESSAGE);
                        }
                        if (rawServiceName.equals("Sha2SigService7")) {
                            ...
                            Sha2SigService7 service = new Sha2SigService7(wsdlURL,
                                            serviceName);
                            dispSOAPMsg = service.createDispatch(servicePort,
                                            SOAPMessage.class, Mode.MESSAGE);
                        }
                        if (rawServiceName.equals("Sha2SigService8")) {
                            ...
                            Sha2SigService8 service = new Sha2SigService8(wsdlURL,
                                            serviceName);
                            dispSOAPMsg = service.createDispatch(servicePort,
                                            SOAPMessage.class, Mode.MESSAGE);
                        }            
