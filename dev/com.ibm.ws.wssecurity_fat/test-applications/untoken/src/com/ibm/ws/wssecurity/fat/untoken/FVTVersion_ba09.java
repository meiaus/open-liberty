...
@WebServiceProvider(targetNamespace="http://wssec.basicssl.cxf.fats",
                    serviceName="FVTVersionBA9Service", portName="UrnBasicPlcyBA9",
 ...
 * @author Todd Roling
 */
public class FVTVersion_ba09 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Body><provider><message>WSSECFVT FVTVersion_ba09</message></provider></SOAP-ENV:Body></SOAP-ENV:Envelope>");
