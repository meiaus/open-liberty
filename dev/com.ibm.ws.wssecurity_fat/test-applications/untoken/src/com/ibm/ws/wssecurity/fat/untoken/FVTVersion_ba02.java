...
@WebServiceProvider(targetNamespace="http://wssec.basicssl.cxf.fats",
                    serviceName="FVTVersionBA2Service", portName="UrnBasicPlcyBA2",
 ...
 * @author Todd Roling
 */
public class FVTVersion_ba02 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Body><provider><message>WSSECFVT FVTVersion_ba02</message></provider></SOAP-ENV:Body></SOAP-ENV:Envelope>");
