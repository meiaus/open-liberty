...
@WebServiceProvider(targetNamespace="http://caller.libertyfat.test/contract",
                    serviceName="FatSamlC09Service", portName="SamlCallerToken09",
...
/**
 */
public class SAMLCaller_bac09 implements javax.xml.ws.Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        String respMsg = new String(
                               ...
                               "<SOAP-ENV:Body><provider><message>Liberty Fat SAMLCaller bac09(" + PrincipalUserID + 
