...
@WebServiceProvider(targetNamespace="http://x509enc.wssecfvt.test",
    portName="UrnX509Enc7",
    serviceName="X509XmlEncService7",
    wsdlLocation = "WEB-INF/X509XmlEnc2.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class X509EncWebSvc7 implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://wssec.basic.cxf.fats/types\"><provider>This is X509EncWebSvc7 Web Service.</provider></soapenv:Body></soapenv:Envelope>");
