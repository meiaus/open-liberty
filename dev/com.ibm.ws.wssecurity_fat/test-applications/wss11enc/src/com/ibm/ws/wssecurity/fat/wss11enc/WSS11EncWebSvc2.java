...
@WebServiceProvider(targetNamespace="http://wss11enc.wssecfvt.test",
    portName="WSS11Enc2",
    serviceName="WSS11EncService2",
    wsdlLocation = "WEB-INF/WSS11Encryption.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class WSS11EncWebSvc2 implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            // StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://wss11enc.wssecfvt.test/types\"><provider>This is Wss11EncWebSvc2 Web Service.</provider></soapenv:Body></soapenv:Envelope>");
            StringReader respMsg = new StringReader(
            	...
            	"<provider>This is Wss11EncWebSvc2 Web Service.</provider></soapenv:Body></soapenv:Envelope>");
