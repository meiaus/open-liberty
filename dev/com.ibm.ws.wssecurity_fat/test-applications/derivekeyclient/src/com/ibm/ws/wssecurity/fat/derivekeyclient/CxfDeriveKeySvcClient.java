...
*/
		...
		try {
			...
			if (rawServiceName.equals("DeriveKeyService1")) {
				...
				DeriveKeyService1 service = new DeriveKeyService1(wsdlURL,
						serviceName);
			...
			if (rawServiceName.equals("DeriveKeyService2")) {
				...
				DeriveKeyService2 service = new DeriveKeyService2(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("DeriveKeyService3")) {
				...
				DeriveKeyService3 service = new DeriveKeyService3(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("DeriveKeyService4")) {
				...
				DeriveKeyService4 service = new DeriveKeyService4(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("DeriveKeyService5")) {
				...
				DeriveKeyService5 service = new DeriveKeyService5(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("DeriveKeyService6")) {
				...
				DeriveKeyService6 service = new DeriveKeyService6(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("DeriveKeyService7")) {
				...
				DeriveKeyService7 service = new DeriveKeyService7(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
