	...
	protected void doWorker(HttpServletRequest request,
		...
		try {
			...
			if (rawServiceName.equals("WSS11SigService1")) {
				...
				WSS11SigService1 service = new WSS11SigService1(wsdlURL,
						serviceName);
			...
			if (rawServiceName.equals("WSS11SigService2")) {
				...
				WSS11SigService2 service = new WSS11SigService2(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService4")) {
				...
				WSS11SigService4 service = new WSS11SigService4(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService5")) {
				...
				WSS11SigService5 service = new WSS11SigService5(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService6")) {
				...
				WSS11SigService6 service = new WSS11SigService6(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService6a")) {
				...
				WSS11SigService6a service = new WSS11SigService6a(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService7")) {
				...
				WSS11SigService7 service = new WSS11SigService7(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService7a")) {
				...
				WSS11SigService7a service = new WSS11SigService7a(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("WSS11SigService8")) {
				...
				WSS11SigService8 service = new WSS11SigService8(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
