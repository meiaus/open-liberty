...
*/
        ...
        try {
            ...
            if( thisMethod.equals( "testCxfX509KeyIdMigSymService" ) ){
                service = (Service)new FatBAX01Service( wsdlURL, serviceName);
                ...
                service = (Service)new FatBAX32Service( wsdlURL, serviceName); 
                strExpect = "LIBERTYFAT X509 bax32";
            } else  if( thisMethod.equals( "testInclusiveC14NService" ) ){
                service = (Service)new FatBAX33Service( wsdlURL, serviceName); 
    ...
    void printExpectingResult( HttpServletResponse response, String answer, String strExpect)
         throws IOException{
    ...
    void printUnexpectingResult( HttpServletResponse response, String answer)
         throws IOException{
    ...
    void printUnexpectingException(HttpServletResponse response, Exception ex)
         throws IOException{
        PrintWriter rsp = getPrintWriter(response);
        rsp.print("<p>pass:" + "false" );
        rsp.print("::" + rawServiceName + "</p>" );
