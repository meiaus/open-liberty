...
*/
		...
		try {
			...
			if (rawServiceName.equals("EndSupTokensService0")) {
				...
				EndSupTokensService0 service = new EndSupTokensService0(wsdlURL,
						serviceName);
			...
			if (rawServiceName.equals("EndSupTokensService0Body")) {
				...
				EndSupTokensService0Body service = new EndSupTokensService0Body(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService0BodyElement")) {
				...
				EndSupTokensService0BodyElement service = new EndSupTokensService0BodyElement(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService0Key")) {
				...
				EndSupTokensService0Key service = new EndSupTokensService0Key(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService1")) {
				...
				EndSupTokensService1 service = new EndSupTokensService1(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService2")) {
				...
				EndSupTokensService2 service = new EndSupTokensService2(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService3")) {
				...
				EndSupTokensService3 service = new EndSupTokensService3(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService4")) {
				...
				EndSupTokensService4 service = new EndSupTokensService4(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService5")) {
				...
				EndSupTokensService5 service = new EndSupTokensService5(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService6")) {
				...
				EndSupTokensService6 service = new EndSupTokensService6(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("EndSupTokensService7")) {
				...
				EndSupTokensService7 service = new EndSupTokensService7(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
