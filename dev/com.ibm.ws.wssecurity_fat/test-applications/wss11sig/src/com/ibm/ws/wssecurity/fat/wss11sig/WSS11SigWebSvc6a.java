...
@WebServiceProvider(targetNamespace="http://wss11sig.wssecfvt.test",
    portName="WSS11Sig6a",
    serviceName="WSS11SigService6a",
    wsdlLocation = "WEB-INF/WSS11Signature.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class WSS11SigWebSvc6a implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            StringReader respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://wss11sig.wssecfvt.test/types\"><provider>This is Wss11SigWebSvc6a Web Service.</provider></soapenv:Body></soapenv:Envelope>");
