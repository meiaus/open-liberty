...
@WebServiceProvider(targetNamespace="http://wssec.pwdigest.cxf.fats",
	serviceName="SOAPServicePWDigest",
    portName="SOAPPortPWDigest",
    wsdlLocation = "WEB-INF/UsrTokenPWDigestWebSvc.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class UsrTokenPWDigestWebSvc implements Provider<SOAPMessage> {
    ...
    public SOAPMessage invoke(SOAPMessage request) {
        ...
        try {
            ...
            String returnMsg = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://wssec.pwdigest.cxf.fats/types\"><provider>This is WSSECFVT CXF Web Service (Password Digest) for: " + hdrText + ".</provider></soapenv:Body></soapenv:Envelope>";
