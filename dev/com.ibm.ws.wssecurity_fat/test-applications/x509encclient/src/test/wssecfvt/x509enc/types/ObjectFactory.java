 ...
 * generated in the test.wssecfvt.x509enc.types package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: test.wssecfvt.x509enc.types
     * 
     */
