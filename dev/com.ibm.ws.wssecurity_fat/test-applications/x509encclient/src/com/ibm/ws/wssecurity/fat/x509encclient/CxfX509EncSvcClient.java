	...
	protected void doWorker(HttpServletRequest request,
		...
		try {
			...
			if (rawServiceName.equals("X509XmlEncService1")) {
				System.out.println("In X509XmlEncService1 case");
				X509XmlEncService1 service = new X509XmlEncService1(wsdlURL,
						serviceName);
			...
			if (rawServiceName.equals("X509XmlEncService1X")) {
				...
				X509XmlEncService1X service = new X509XmlEncService1X(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService2")) {
				...
				X509XmlEncService2 service = new X509XmlEncService2(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService3")) {
				...
				X509XmlEncService3 service = new X509XmlEncService3(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService4")) {
				...
				X509XmlEncService4 service = new X509XmlEncService4(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService5")) {
				...
				X509XmlEncService5 service = new X509XmlEncService5(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService6")) {
				...
				X509XmlEncService6 service = new X509XmlEncService6(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService7")) {
				...
				X509XmlEncService7 service = new X509XmlEncService7(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService8")) {
				...
				X509XmlEncService8 service = new X509XmlEncService8(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService9")) {
				...
				X509XmlEncService9 service = new X509XmlEncService9(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
			...
			if (rawServiceName.equals("X509XmlEncService10")) {
				...
				X509XmlEncService10 service = new X509XmlEncService10(wsdlURL,
						serviceName);
				service.addPort(servicePort,SOAPBinding.SOAP11HTTP_BINDING,endPtUrl);
				dispSOAPMsg = service.createDispatch(servicePort,
						SOAPMessage.class, Mode.MESSAGE);
