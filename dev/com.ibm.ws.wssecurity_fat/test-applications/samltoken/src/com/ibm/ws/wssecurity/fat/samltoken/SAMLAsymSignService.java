...
@WebServiceProvider(targetNamespace="http://wssec.basic.cxf.fats",
    portName="SAMLAsymSignPort",
    serviceName="SAMLAsymSignService",
    wsdlLocation = "WEB-INF/SamlTokenWebSvc.wsdl"
)

@ServiceMode(value = Service.Mode.MESSAGE)

public class SAMLAsymSignService implements Provider<SOAPMessage> {
...
//            }
            ...
            if (com.ibm.ws.wssecurity.fat.samltoken.utils.isSAMLAssertionInHeader(request)) {
                ...
                respMsg = new StringReader("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body xmlns=\"http://wssec.basic.cxf.fats/types\"><provider>This is WSSECFVT CXF Asymmetric Signature Web Service (using SAML).</provider></soapenv:Body></soapenv:Envelope>");
            } else {
