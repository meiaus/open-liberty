...
public class UpdateServerXml {
    ...
    public static void reconfigServer(LibertyServer server, String copyFromFile)
                    throws Exception {
    ...
    public static void reconfigServer(LibertyServer server, String copyFromFile, String methodName)
                    throws Exception {
        CommonTests.server = server;
